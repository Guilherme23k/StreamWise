...
export class DataCardService {
  ...
  private readonly apiUrlGET = 'http://streamwise-production.up.railway.app/signatures/user/me/signatures';
  private readonly apiUrl = 'http://streamwise-production.up.railway.app/signatures';
